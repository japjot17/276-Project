...
var orig_address = document.getElementById("orig-address").innerHTML;
var dest_address = document.getElementById("dest-address").innerHTML;
var travel_mode = document.getElementById("travel-mode").innerHTML;
var travel_time = document.getElementById("travel-time").innerHTML;
...
const createPlaylist = async () => {
  ...
  var date =
    ...
    ":" +
    today.getMinutes();
  var playlistName = `PERSONGIFY Travel: ${orig_address} to ${dest_address} (${date})`;
  var playlistDesc = `A ${genre} playlist generated by PERSONGIFY. Travel mode: ${travel_mode}`;
